...
import multimodalIcon from '../assets/img/Icono Multimodal.png';
import courierIcon from '../assets/img/Icono Courier.png';
  ...
  return (
    <section id="services" className="py-16 sm:py-20 lg:py-24 bg-[#efeff1]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          // ... (omitting unchanged lines if possible, but I need to match context)
          // Wait, I can't skip lines inside the replacement content if I'm replacing a block.
            ...
            >
              <Card className="h-full hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 bg-white border-none p-6 sm:p-8">
                <CardHeader className="p-0 pb-6">
                  <div
                    className="w-20 h-20 sm:w-24 sm:h-24 rounded-full mb-6 mx-auto overflow-hidden"
                  >
